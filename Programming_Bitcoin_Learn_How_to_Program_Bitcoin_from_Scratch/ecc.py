...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        for i in additions:
            x1 = FieldElement(num=i[0], prime=prime)
            y1 = FieldElement(num=i[1], prime=prime)
            x2 = FieldElement(num=i[2], prime=prime)
            y2 = FieldElement(num=i[3], prime=prime)
            x3 = FieldElement(num=i[4], prime=prime)
            y3 = FieldElement(num=i[5], prime=prime)
            p1 = Point(x1, y1, a, b)
            p2 = Point(x2, y2, a, b)
            p3 = Point(x3, y3, a, b)
